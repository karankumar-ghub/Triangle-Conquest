            ...
            <div className="flex flex-col gap-4 w-full max-w-xs z-10">
                ...
                <div className="flex gap-3">
                    <button 
                        ...
                        className="flex-1 py-3 bg-slate-800/50 border border-white/5 rounded-xl font-bold text-xs text-slate-300 hover:bg-slate-700 hover:text-white transition-colors"
                    >
                        📖 HOW TO PLAY
                    </button>
                    <button 
